 ...
 * @author huliqing
 */
public class ArticleSecurityConverter implements TypeConverter{

    public Object getAsObject(String strValue) {
        if (strValue == null || "".equals(strValue))
            return null;
        ArticleSecurity result = null;
        try {
            result = ArticleSecurity.valueOf(strValue);
        } catch (Exception e) {
            return null;
        }
        return result;
    ...
    public String getAsString(Object objValue) {
        if (objValue == null)
            return "";
        return ((ArticleSecurity) objValue).name();
    }
