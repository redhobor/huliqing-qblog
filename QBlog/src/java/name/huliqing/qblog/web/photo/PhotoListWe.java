...
@ManagedBean
@RequestScoped
public class PhotoListWe extends BaseWe {
...
//    private String currentURL;
    ...
    public PhotoListWe() {
        ...
        if (tempFolderId != null) {
            folder = FolderSe.find(tempFolderId);
        }
    }
    ...
    public PageModel<PhotoEn> loadData(PageParam pp) {
        if (folder == null) {
            QBlog.redirect("/admin/photo/folderList.faces");
            return null;
        }
        PageModel<PhotoEn> pes = PhotoSe.findByFolderId(pp, folder.getFolderId());
        return pes;
    }
